...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_desc,a.product_image,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
			...
			<form method="post" action="login_form.php">
				...
				<tfoot>
					...
					<tr>
						...
						<td class="hidden-xs text-center">Total: ksh<b class="net_total" ></b></td>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							$x=0;
							$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
							$query = mysqli_query($con,$sql);
							while($row=mysqli_fetch_array($query)){
								$x++;
								echo  	
