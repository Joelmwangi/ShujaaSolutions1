  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/1.png" alt="Los Angeles" style="width:100%; height:400px;">
        
      </div>

      <div class="item">
        <img src="img/6.png" style="width:100%; height:400px;" >
        
      </div>
    
      <div class="item">
        <img src="img/5.png" alt="New York" style="width:100%; height:400px;">
        
      </div>

      <div class="item">
        <img src="img/3.png" alt="New York" style="width:100%; height:400px;">
        
      </div>
      <div class="item">
        <img src="img/4.png" alt="New York" style="width:100%; height:400px;">
        
      </div>
      <div class="item">
        <img src="img/banner_img4.gif" alt="New York" style="width:100%; height:400px;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							<div class="shop-img">
								<img src="./img/watch.png" alt="" height: 100px>
							</div>
							<div class="shop-body">
								<h3>Watches<br>Collection</h3>
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Ksh</del></h4>
